...
# Prediction
We have used www.alphavantage.co API to get the real time data and modified the data according to the requirements to get the new features for prediction.
